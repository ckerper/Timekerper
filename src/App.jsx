...
const LAST_UPDATED = '2026-02-22 10:25 PM CT'
  ...
  return (
    <div className="app">
      ...
      <header className="header">
        <h1>Timekerper{syncEnabled && <span className={`sync-indicator ${syncStatus}`} title={syncStatus === 'error' ? syncError : syncStatus === 'syncing' ? 'Syncing...' : lastSynced ? `Last synced ${formatSyncTime(lastSynced)}` : 'Connected'} />}</h1>
